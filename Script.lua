...
if msg.content_.ID == "MessageChatAddMembers" and redis:get(angel..'welcome:get'..msg.chat_id_) then
...
welcome = (redis:get(angel..'welcome:msg'..msg.chat_id_) or "- أهلاًً حبيبي\n-نورت المجموعة .")
welcome = welcome:gsub("{القوانين}", redis:get(angel..'rulse:msg'..msg.chat_id_) or "- الابتعاد عن الألفاظ القذرة.\n- الابتعاد عن العنصرية.\n- عدم نشر صور ومقاطع غير اخلاقية.\n- احترام مالك القروب واعضاء القروب.")
...
SendMention(msg.chat_id_,datau.id_,msg.id_,"•~العضو » "..USERNAME.."\n•~قمـت بتكرآر آكثر مـن "..NUM_MSG_angel.." رسـآله‌‏ , لذآ تم تقييدك مـن آلمـجمـوعه‌‏ ✓\n",12,USERCAR) 
return false
end)
end 
...
local ss97 = {
"لبييه .","عيوني .",
"امرني .","وشفي ؟","ها .","شفيك تصيح !",
"امرني يا حلو .","عيوني لك .","تدلل .",
"ها يا عمري .","ها يا روحي .","طفشتني .",
"عيون ["..Bot_Name.."] .",
}
local bs = {
"امح .",
...
return sendMsg(msg.chat_id_,msg.id_,"اكثريا روحي .")
...
elseif Text== "هاي"  then return sendMsg(msg.chat_id_,msg.id_,"افخم هاي .")
