...
─────▀██▀─────
┊Angel‿ @TVWTT
تم تطوير وبرمجة السورس من قبل مستر ┊
┊@TVWTT
#-------------------------------------------------------------------
]]
...
SUDO_USER = redis:hgetall(angel..'username:'..SUDO_ID).username
sendPhoto(msg.chat_id_,msg.id_,redis:get(angel..':WELCOME_BOT'),[[•~مـرحبآ آنآ بوت آسـمـي ]]..redis:get(angel..':NameBot:')..[[•~آختصـآصـي حمـآيه‌‏ آلمـجمـوعآت
